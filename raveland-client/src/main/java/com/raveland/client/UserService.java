...
public class UserService {
  ...
  public interface Iface {
    ...
    public int add(com.raveland.client.UserCmd cmd) throws org.apache.thrift.TException;

  }

  public interface AsyncIface {

    public void add(com.raveland.client.UserCmd cmd, org.apache.thrift.async.AsyncMethodCallback<java.lang.Integer> resultHandler) throws org.apache.thrift.TException;
  ...
  public static class Client extends org.apache.thrift.TServiceClient implements Iface {
    ...
    public void send_add(com.raveland.client.UserCmd cmd) throws org.apache.thrift.TException
    {
  ...
  public static class AsyncClient extends org.apache.thrift.async.TAsyncClient implements AsyncIface {
    ...
    public void add(com.raveland.client.UserCmd cmd, org.apache.thrift.async.AsyncMethodCallback<java.lang.Integer> resultHandler) throws org.apache.thrift.TException {
      checkReady();
      add_call method_call = new add_call(cmd, resultHandler, this, ___protocolFactory, ___transport);
      this.___currentMethod = method_call;
      ___manager.call(method_call);
    }

    public static class add_call extends org.apache.thrift.async.TAsyncMethodCall<java.lang.Integer> {
      private com.raveland.client.UserCmd cmd;
      public add_call(com.raveland.client.UserCmd cmd, org.apache.thrift.async.AsyncMethodCallback<java.lang.Integer> resultHandler, org.apache.thrift.async.TAsyncClient client, org.apache.thrift.protocol.TProtocolFactory protocolFactory, org.apache.thrift.transport.TNonblockingTransport transport) throws org.apache.thrift.TException {
  ...
  public static class Processor<I extends Iface> extends org.apache.thrift.TBaseProcessor<I> implements org.apache.thrift.TProcessor {
    ...
    public static class add<I extends Iface> extends org.apache.thrift.ProcessFunction<I, add_args> {
      ...
      public add_result getResult(I iface, add_args args) throws org.apache.thrift.TException {
        add_result result = new add_result();
        result.success = iface.add(args.cmd);
  ...
  public static class AsyncProcessor<I extends AsyncIface> extends org.apache.thrift.TBaseAsyncProcessor<I> {
    ...
    public static class add<I extends AsyncIface> extends org.apache.thrift.AsyncProcessFunction<I, add_args, java.lang.Integer> {
      ...
      public void start(I iface, add_args args, org.apache.thrift.async.AsyncMethodCallback<java.lang.Integer> resultHandler) throws org.apache.thrift.TException {
        iface.add(args.cmd,resultHandler);
      }
    }
  ...
  public static class add_args implements org.apache.thrift.TBase<add_args, add_args._Fields>, java.io.Serializable, Cloneable, Comparable<add_args>   {
    ...
    public @org.apache.thrift.annotation.Nullable com.raveland.client.UserCmd cmd; // required
    ...
    static {
      ...
      tmpMap.put(_Fields.CMD, new org.apache.thrift.meta_data.FieldMetaData("cmd", org.apache.thrift.TFieldRequirementType.DEFAULT, 
          new org.apache.thrift.meta_data.StructMetaData(org.apache.thrift.protocol.TType.STRUCT, com.raveland.client.UserCmd.class)));
    ...
    public add_args(
      com.raveland.client.UserCmd cmd)
    {
      this();
      this.cmd = cmd;
    }
    ...
    public add_args(add_args other) {
      if (other.isSetCmd()) {
        this.cmd = new com.raveland.client.UserCmd(other.cmd);
      }
    }
    ...
    @org.apache.thrift.annotation.Nullable
    public com.raveland.client.UserCmd getCmd() {
      return this.cmd;
    }

    public add_args setCmd(@org.apache.thrift.annotation.Nullable com.raveland.client.UserCmd cmd) {
      this.cmd = cmd;
      return this;
    }
    ...
    public void setFieldValue(_Fields field, @org.apache.thrift.annotation.Nullable java.lang.Object value) {
      ...
      case CMD:
        if (value == null) {
          ...
          setCmd((com.raveland.client.UserCmd)value);
        }
        break;
          ...
          switch (schemeField.id) {
            case 1: // CMD
              if (schemeField.type == org.apache.thrift.protocol.TType.STRUCT) {
                struct.cmd = new com.raveland.client.UserCmd();
